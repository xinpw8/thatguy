import random
from pokemonred_puffer import data_file
...
EXCLUDED_EVENTS = [
    ...
    (0xD7EE, 1), # EVENT_VICTORY_ROAD_2_TRAINER_0
    (0xD7EE, 2), # EVENT_VICTORY_ROAD_2_TRAINER_1
    (0XD7EE, 3), # EVENT_VICTORY_ROAD_2_TRAINER_2
    (0xD7EE, 4), # EVENT_VICTORY_ROAD_2_TRAINER_3
    (0xD7EE, 5), # EVENT_VICTORY_ROAD_2_TRAINER_4
    (0XD7EE, 6), # EVENT_BEAT_MOLTRES
    (0xD7EE, 7), # EVENT_VICTORY_ROAD_2_BOULDER_ON_SWITCH2
(0xD813, 0),  # EVENT_VICTORY_ROAD_3_BOULDER_ON_SWITCH1
(0xD813, 1),  # EVENT_BEAT_VICTORY_ROAD_3_TRAINER_0
(0xD813, 2),  # EVENT_BEAT_VICTORY_ROAD_3_TRAINER_1
(0xD813, 3),  # EVENT_BEAT_VICTORY_ROAD_3_TRAINER_2
(0xD813, 4),  # EVENT_BEAT_VICTORY_ROAD_3_TRAINER_3
(0xD813, 6),  # EVENT_VICTORY_ROAD_3_BOULDER_ON_SWITCH2
(0xD869, 1),  # EVENT_BEAT_VICTORY_ROAD_1_TRAINER_0
(0xD869, 2),  # EVENT_BEAT_VICTORY_ROAD_1_TRAINER_1
(0xD869, 7),  # EVENT_VICTORY_ROAD_1_BOULDER_ON_SWITCH
(0xD7EB, 1),  # EVENT_2ND_ROUTE22_RIVAL_BATTLE
(0xD7EB, 6),  # EVENT_BEAT_ROUTE22_RIVAL_2ND_BATTLE
(0xD7EB, 7),  # EVENT_ROUTE22_RIVAL_WANTS_BATTLE
(0xD7ED, 0),  # EVENT_PASSED_CASCADEBADGE_CHECK
(0xD7ED, 1),  # EVENT_PASSED_THUNDERBADGE_CHECK
(0xD7ED, 2),  # EVENT_PASSED_RAINBOWBADGE_CHECK
(0xD7ED, 3),  # EVENT_PASSED_SOULBADGE_CHECK
(0xD7ED, 4),  # EVENT_PASSED_MARSHBADGE_CHECK
(0xD7ED, 5),  # EVENT_PASSED_VOLCANOBADGE_CHECK
(0xD7ED, 6),  # EVENT_PASSED_EARTHBADGE_CHECK
    
    
    
]

ROUTE_22_RIVAL_BATTLE_HACK = [
    (0xD7EB, 0),  # EVENT_1ST_ROUTE22_RIVAL_BATTLE
    (0xD7EB, 5),  # EVENT_BEAT_ROUTE22_RIVAL_1ST_BATTLE
]
